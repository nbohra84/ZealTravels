...
using ZealTravel.Backoffice.Web.Models.Agency.Booking;
using log4net.Core;
...
namespace ZealTravel.Backoffice.Web.Controllers
{
    ...
    : Convert.ToDouble(flightDetails.FirstOrDefault()?.TotalMarkup.ToString())
                ...
                sbResponse.Append("<td style='font-size:35px;' width='33%' align='center'> INVOICE D </td>");
                sbResponse.Append("<td style='font-size:35px;' width='33%' align='center'>   </td>");
                sbResponse.Append("</tr>");
                sbResponse.Append("<tr>");
            ...
            catch (Exception ex)
            {
                var addDBLogger = new AddDBLogCommand
                {
                    ...
                    BookingRef = iBookingRef,
                    MethodName = "Print_Air_Invoice",
                    Location = "PrintController",
                    SearchCriteria = string.Empty,
                    SearchID = string.Empty,
                    ErrorMessage = ex.Message,
                };

                _addDbLogCommandHandler.HandleAsync(addDBLogger);
    ...
    : Convert.ToDouble(flightDetails.FirstOrDefault()?.TotalMarkup.ToString())
                ...
                sbResponse.Append("<tr>");
                sbResponse.Append("<td>");
                sbResponse.Append("<table style='font-size:15px;width:785px;' cellspacing='0' cellpadding='5' border='0' >");
                sbResponse.Append("<tbody>");
                sbResponse.Append("<tr>");
                sbResponse.Append("<td style='font-size:35px;' width='33%' align='center'>   </td>");
                sbResponse.Append("<td style='font-size:35px;' width='33%' align='center'> INVOICE D </td>");
                    ...
                    foreach (var fltDetails in flightDetails)
                    {
                        ...
                        if (totalpax > 0)
                        {
                            ...
                            foreach (var paxDetail in paxDetails)
                            {
                                ...
                                sbResponse.Append("<tr>");
                                sbResponse.Append("<td style='border-top: 1px solid rgba(0, 0, 0, 0.17);border-right: 1px solid #ccc;'>");
                                sbResponse.Append("<span>" + (sno + 1) + "</span>");
                                sbResponse.Append("</td>");
                                sbResponse.Append("<td style='border-top: 1px solid rgba(0, 0, 0, 0.17);border-right: 1px solid #ccc;'>");
                                sbResponse.Append("<span> " + ticketno + "</span>");
                                sbResponse.Append("</td>");
            ...
            if (int.TryParse(bookingRefDecoded, out int iBookingRef) && iBookingRef > 0)
            {
                ...
                if (!string.IsNullOrEmpty(printPopupPdfRequest.Pax_SegmentId))
                {
                    ...
                    if (flightbooking != null)
                    {
                        ...
                        StringBuilder reportHTML = new StringBuilder(PrintPassengerPopupPdf(
                            flightbooking,
                            iBookingRef,
...

        {
            ...
            try
            {
                ...
                sbResponse.Append("<table style='margin-left:-45px;margin-top:-40px;border: 1px solid #D6D8E7; width: 785px;  font-size: 11px; font-family: math;' cellspacing='3' id='showmndetail' runat='server'>");
                //if (compDetails.Count() > 0)
                //{
                sbResponse.Append("<tr id='logodiv'>");
                sbResponse.Append("<td style='border-bottom: 1px solid #d6d8e7;'>");
                ...
                sbResponse.Append("<tr>");
                sbResponse.Append("<td>");
                sbResponse.Append("<table  style='border-bottom: 1px solid #D6D8E7;background: #fff;width: 100%;' cellpadding='10' >");
                sbResponse.Append("<tr>");
                ...
                sbResponse.Append("<span style='font-size: 15px; color: #929292;' >Email: </span><span id='CEmail'>" + Email.ToLower() + "</span>"); ;
                sbResponse.Append("</span>");
                sbResponse.Append("</td>");

                sbResponse.Append("<td width='33%' align='center' >");
                sbResponse.Append("<b style=' font-size:25px;'>E - Ticket A </b>");
                sbResponse.Append("</td>");
            ...
            if (!string.IsNullOrWhiteSpace(printPoupEmailRequest.BookingRef) && !string.IsNullOrWhiteSpace(printPoupEmailRequest.Email))
            {
                ...
                if (int.TryParse(bookingRefDecoded, out int iBookingRef))
                {
                    ...
                    if (flightbooking != null)
                    {
                        ...
                        string reportHTML = PrintPopupPdf(flightbooking, iBookingRef, printPoupEmailRequest.Tax, printPoupEmailRequest.ShowLogo, UserHelper.GetCompanyID(User), printPoupEmailRequest.HideFare, printPoupEmailRequest.Disc);
                        //string baseUri = $"{Request.Scheme}://{Request.Host.Value}/";
                        string baseUri = Directory.GetCurrentDirectory();
    ...
    decimal.TryParse(companyTransactionDetail.FirstOrDefault().SurchargeAmount.ToString(), out var surchargeAmount))
                ...
                sbResponse.Append("</td>");
                sbResponse.Append("<td width='33%' align='center' >");
                sbResponse.Append("<b style=' font-size:27px;'>E - Ticket G </b>");
                sbResponse.Append("</td>");
                sbResponse.Append("<td width='33%' valign='top' align='left' style='font-size: 15px;' >");
                sbResponse.Append("");
...

        {
            ...
            try
            {
                ...
                foreach (var paxItem in paxDetails)
                {
                    //DataRow drPassenger = paxDetails.Rows[i];
                ...
                sbResponse.Append("<table width='100%'>");
                int _totalfare = 0;
                //if (fareDetailSeg != null && fareDetailSeg.Rows.Count > 0)
                //{
                //heading
                sbResponse.Append("<tr>");
                //  one
        ...
        private string GetSectorWiseDetailsOB(List<CompanyFlightDetailAirlinesData> flightDetail, List<CompanyFlightSegmentDetailAirlinesData> flightSegmentDetail, bool isItCallingInPDFMethod = false)
        {
            ...
            foreach (var paxSegment in flightSegmentDetail)
            {
                ...
                if (n > -1)
                {
                    ...
                    _HTMLItinery = _HTMLItinery + "<tr>";
                    _HTMLItinery = _HTMLItinery + "<td width='20%' valign='top' style='font-size:15px;padding: 10px;' >";
                    if (isItCallingInPDFMethod)
                    {
                    ...
                    _HTMLItinery = _HTMLItinery + "<span style='margin-top: 5px; width: 100%; float: left;margin-right:5px;'>" + paxSegment.DepartureStation + " (" + DepartureStationAirport + " , " + DepartureStation + " ) </span><span style='margin-top: 5px; width: 100%; float: left;margin-right:5px;'>" + paxSegment.DepartureTime + ", " + DepartureDate + "</span>";

                    _HTMLItinery = _HTMLItinery + "<span style = 'margin-top: 5px; width: 100%; float: left;margin-right:5px;'>Terminal-" + DepartureTerminal + " </ span > ";
                    ...
                    _HTMLItinery = _HTMLItinery + "<td width='40%' valign='top' style='font-size:15px'>";
                    _HTMLItinery = _HTMLItinery + "<span style='margin-top: 5px; width: 100%; float: left;margin-right:5px;'> " + paxSegment.ArrivalStation + " (" + ArrivalStationAirport + ",   " + ArrivalStation + ") </span>";
                    _HTMLItinery = _HTMLItinery + "<span style='margin-top: 5px; width: 100%; float: left;margin-right:5px;'>" + paxSegment.ArrivalTime + " , " + StringHelper.GetFirstCharacterCapital(paxSegment.ArrivalDate) + " </span>";
                    _HTMLItinery = _HTMLItinery + "<span style = 'margin-top: 5px; width: 100%; float: left;margin-right:5px;'>Terminal-" + ArrivalTerminal + " </ span > ";
                    _HTMLItinery = _HTMLItinery + "</td>";
                    _HTMLItinery = _HTMLItinery + "</tr>";
                }
            }
        ...
        private string GetSectorWiseDetailsIB(List<CompanyFlightDetailAirlinesData> flightDetail, List<CompanyFlightSegmentDetailAirlinesData> flightSegmentDetail, bool isItCallingInPDFMethod = false)
        {
            ...
            foreach (var paxSegment in flightSegmentDetail)
            {
                ...
                if (m > -1)
                {
                    ...
                    _HTMLItinery = _HTMLItinery + "<tr>";
                    _HTMLItinery = _HTMLItinery + "<td width='20%' valign='top' style='font-size:15px'>";
                    if (isItCallingInPDFMethod)
                    {
                        _HTMLItinery = _HTMLItinery + "<span style='margin-top: 5px;width: 100%;height: 29px;float: left;width:max-content;margin-right: 10px'><img src='wwwroot\\assets\\img\\airlogo_square\\" + CarrierCode + ".gif' height='30px' width='30px' alt='" + CarrierCode + "' />";
                    }
                    else
                    {
                    _HTMLItinery = _HTMLItinery + "<span style='margin-top: 5px;width: 100%;height: 29px;float: left;width:max-content;margin-right: 10px'><img src='/assets/img/airlogo_square/" + CarrierCode + ".gif' height='30px' width='30px' alt='" + CarrierCode + "' />";
                    }
                    _HTMLItinery = _HTMLItinery + "</span><span style='margin-top: 5px;width: 70%;float: left;'>";
                    _HTMLItinery = _HTMLItinery + "<span style='margin-left: 5px;'>" + CarrierName + "</span><span style='margin-left: 5px;'>" + CarrierCode + "</span><span style='margin-left: 5px;'>" + paxSegment.FlightNumber + "</span><span style='margin-left: 5px;'>" + ClassOfService + "</span><span style='margin-left:5px;'> Class</span><br /></span>";
                    _HTMLItinery = _HTMLItinery + "</td>";
                    ...
                    _HTMLItinery = _HTMLItinery + "<td width='40%' valign='top' style='font-size:15px;' >";
                    _HTMLItinery = _HTMLItinery + "<span style='margin-top: 5px; width: 100%; float: left;margin-right:5px;'>" + paxSegment.DepartureStation + "  (" + DepartureStationAirport + " , " + paxSegment.sDepartureStation + "  ) </span>";
                    _HTMLItinery = _HTMLItinery + "<span style='margin-top: 5px; width: 100%; float: left;margin-right:5px;'>" + paxSegment.DepartureTime + ", " + StringHelper.GetFirstCharacterCapital(DepartureDate) + "</span>";
                    _HTMLItinery = _HTMLItinery + "<span style = 'margin-top: 5px; width: 100%; float: left;margin-right:5px;'>Terminal-" + DepartureTerminal + " </ span > ";
                    _HTMLItinery = _HTMLItinery + "</td>";
                    _HTMLItinery = _HTMLItinery + "<td width='40%' valign='top' style='font-size:15px;'>";
                    _HTMLItinery = _HTMLItinery + "<span style='margin-top: 5px; width: 100%; float: left;margin-right:5px;'> " + paxSegment.ArrivalStation + " (" + ArrivalStationAirport + ",   " + paxSegment.sArrivalStation + ") </span>";
                    _HTMLItinery = _HTMLItinery + "<span style='margin-top: 5px; width: 100%; float: left;margin-right:5px;'>  " + paxSegment.ArrivalTime + " , " + StringHelper.GetFirstCharacterCapital(paxSegment.ArrivalDate) + " </span>";
                    _HTMLItinery = _HTMLItinery + "<span style = 'margin-top: 5px; width: 100%; float: left;margin-right:5px;'>Terminal-" + ArrivalTerminal + " </ span > ";
                    _HTMLItinery = _HTMLItinery + " </td>";
                    _HTMLItinery = _HTMLItinery + "</tr>";
