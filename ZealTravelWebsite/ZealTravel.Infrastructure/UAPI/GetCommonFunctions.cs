...
namespace ZealTravel.Infrastructure.UAPI
{
    public class GetCommonFunctions
    {
        ...
        public static bool SetErrorLogs(string Searchid, string MethodName, string PageName, string Supplierid, string ErrorMessages)
        {
            //WriteFileToTXT(ErrorMessages, Searchid + "_RQ_" + MethodName + "_" + PageName);
            return true;
        }
        public static bool SetApiLogs(string Searchid, string MethodName, string PageName, string Request, string Response, string Supplierid)
        {
            //WriteFileToXML(Request, Searchid + "_RQ_" + MethodName);
            //WriteFileToXML(Response, Searchid + "_RS_" + MethodName);
