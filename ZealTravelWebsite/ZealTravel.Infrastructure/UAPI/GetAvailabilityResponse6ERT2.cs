...
{
    class GetAvailabilityResponse6ERT2
    {
        ...
        public GetAvailabilityResponse6ERT2(string NetworkUserName, string NetworkPassword, string TargetBranch, string Adt, string Chd, string Inf, string Origin, string Destination)
        {
        ...
        public DataTable SetAvailabilityResponse(string SearchID, string CompanyID, string Sector, bool IsRT, bool IsMC, string PSQRequest, string UApiResponse, string FltType, string AdtBTR, string ChdBTR, string InfBTR)
        {
            ...
            {
                DBCommon.Logger.dbLogg(CompanyID, 0, "GetAvailabilityResponse6ERT2" + "air_uapi", PSQRequest, UApiResponse, SearchID, ex.Message + "," + ex.StackTrace);
            }
            return dtBound;
        }
