...
namespace ZealTravel.Infrastructure.UAPI
{
    class GetAirCreatePnrRequest
    {
        ...
        public GetAirCreatePnrRequest(string NetworkUserName, string NetworkPassword, string TargetBranch, string UserName, string Password, string SearchID, string CompanyID, int BookingRef, IBookingManagementService bookingService)
        {
        ...
        public async Task<string> GetBookRequest(string CompanyID, DataTable dtSelect, DataTable dtPassenger, DataTable dtCompanyInfo, DataTable dtGstInfo, string PaymentType)
        {
            string Request = "";
            try
            {
                ...
                for (int i = 0; i < dtAdults.CopyToDataTable().Rows.Count; i++)
                {
                    ...
                    if (i.Equals(0))
                    {
                        ...
                        {
                            Request += @"<com:SSR Key=" + "\"" + iSSR + "\"" + " Status=" + "\"" + "NN" + "\"" + " Type =" + "\"" + dr["MealCode_O"].ToString().Trim() + "\"" + " SegmentRef=" + "\"" + SegmentRef + "\"" + "  Carrier = " + "\"" + CarrierCode + "\"" + "/>";
                            iSSR++;
                        }
                        if (dr["MealCode_I"].ToString().Trim().Length > 2)
                        {
                            Request += @"<com:SSR Key=" + "\"" + iSSR + "\"" + " Status=" + "\"" + "NN" + "\"" + " Type =" + "\"" + dr["MealCode_I"].ToString().Trim() + "\"" + " SegmentRef=" + "\"" + SegmentRef + "\"" + "  Carrier = " + "\"" + CarrierCode + "\"" + "/>";
                            iSSR++;
                        }

                        if (dr["FFN"].ToString().Trim().Length > 0)
                        {
                            string nm = dr["Last_Name"].ToString().Trim() + "/" + dr["First_Name"].ToString().Trim() + dr["Title"].ToString().Trim();

                            string Code = "";
                            string Number = "";
                            GetBookFunctions.GetFFN(CompanyID, BookingRef, dr["FFN"].ToString().Trim(), FltType, out Code, out Number);
                            //Request += @"<com:LoyaltyCard xmlns:com =""http://www.travelport.com/schema/common_v51_0"" SupplierCode=" + "\"" + Code + "\"" + " CardNumber=" + "\"" + Number + "\"" + "/>";
                            Request += @"<com:SSR Key=" + "\"" + iSSR + "\"" + " Status=" + "\"" + "HK" + "\"" + " Type =" + "\"" + "FQTV" + "\"" + " Carrier = " + "\"" + CarrierCode + "\"" + "  FreeText = " + "\"" + Code + Number + "-" + nm + "\"" + "/>";
                            iSSR++;
                        }
                        ...
                        if (Sector.Equals("I"))
                        {
                            ...
                            Request += @"<com:SSR Type=""CTCM"" Status=""HK"" Carrier= " + "\"" + CarrierCode + "\"" + " FreeText=" + "\"" + MobileNo + "\"" + " Key=" + "\"" + Convert.ToBase64String(Encoding.ASCII.GetBytes(Guid.NewGuid().ToString("N").Substring(0, 16))) + "\"" + "/>";
                            Request += @"<com:SSR Type=""CTCE"" Status=""HK"" Carrier=" + "\"" + CarrierCode + "\"" + "  FreeText=" + "\"" + kkEmail + "\"" + " Key=" + "\"" + Convert.ToBase64String(Encoding.ASCII.GetBytes(Guid.NewGuid().ToString("N").Substring(0, 16))) + "\"" + "/>";
                ...
                if (dtInfants.Length > 0)
                {
                    ...
                    for (int i = 0; i < dtInfants.CopyToDataTable().Rows.Count; i++)
                    {
                        ...
                        Request += @"<com:BookingTraveler Key=" + "\"" + InfBTR[i].ToString() + "\"" + " TravelerType =" + "\"INF\"" + " Gender=" + "\"" + Gender + "\"" + " Age=" + "\"" + Age + "\"" + ">";
                        Request += @"<com:BookingTravelerName Prefix=" + "\"" + dr["Title"].ToString().Trim() + "\"" + " Last=" + "\"" + dr["Last_Name"].ToString().Trim() + "\"" + " First=" + "\"" + dr["First_Name"].ToString().Trim() + "\"" + "/>";
                        Request += @"<com:PhoneNumber Number=" + "\"" + PassengerMobile + "\"" + "/>";
                        Request += @"<com:Email EmailID=" + "\"" + Email + "\"" + "/>";
                        ...
                        Request += @"<com:RemarkData>" + dtInfant.ToString("ddMMMyy") + "</com:RemarkData>";
                        Request += @"</com:NameRemark>";
                        Request += @"</com:BookingTraveler>";
                        passengerid++;
                    }
                ...
                if (dtChilds.Length > 0)
                {
                    ...
                    for (int i = 0; i < dtChilds.CopyToDataTable().Rows.Count; i++)
                    {
                        ...
                        Request += @"<com:BookingTraveler Key=" + "\"" + ChdBTR[i].ToString() + "\"" + " TravelerType=" + "\"CNN\"" + " Gender=" + "\"" + Gender + "\"" + " Age=" + "\"" + Age + "\"" + ">";
                        Request += @"<com:BookingTravelerName Prefix=" + "\"" + dr["Title"].ToString().Trim() + "\"" + " Last=" + "\"" + dr["Last_Name"].ToString().Trim() + "\"" + " First=" + "\"" + dr["First_Name"].ToString().Trim() + "\"" + "/>";
                        ...
                        Request += @"<com:NameRemark>";
                        Request += @"<com:RemarkData>" + "\"" + "P-C" + Age.ToString() + "\"" + "</com:RemarkData>";
                        Request += @"</com:NameRemark>";
                        Request += @"</com:BookingTraveler>";
                ...
                //string text = "CTCM" + dtAdults.CopyToDataTable().Rows[0]["MobileNo"].ToString() + "PAX";
                //Request += @"<com:OSI Key=""1"" xmlns:com=""http://www.travelport.com/schema/common_v51_0"" Carrier=" + "\"" + dtSelect.Rows[0]["CarrierCode"].ToString() + "\"" + " Text=" + "\"" + text + "\"" + " ProviderCode=" + "\"1G\"" + "/>";
                ////<common:OSI Carrier = "EK" Key = "1" Text = "CTCM 7338572657 PAX" ProviderCode = "1G" xmlns:common = "http://www.travelport.com/schema/common_v51_0" />

                //Request += @"<com:ContinuityCheckOverride>true</com:ContinuityCheckOverride>";
                ...
                //Request += @"<com:ContinuityCheckOverride Key=""true "">true</com:ContinuityCheckOverride>";
                ...
                CommonUapi objCommonUapi = new CommonUapi();
                if (!PaymentType.ToUpper().Equals("PAYMENTHOLD"))
                {
                    if ((await _bookingService.GetActiveFormOfPayment()).Equals("CASH"))
                    {
                        Request += @"<com:FormOfPayment Key=""1"" Type=""Cash""/>";
                    }
                    else
                    {
                        ...
                        if (drCC != null)
                        {
                                ...
                                {
                                    Request += @"<com:FormOfPayment Key = ""1"" Type=""Credit"">";
                                    Request += @"<com:CreditCard BankCountryCode=""IN"" BankName=""VISA"" CVV=""123"" ExpDate=""2040-09"" Name=""Test Travelport"" Number=""4111111111111111"" Type=""VI""  Key=""1"">";
                                    Request += @"<com:BillingAddress>";
                                    Request += @"<com:AddressName>Home</com:AddressName>";
                                    Request += @"<com:Street>Richmond Road</com:Street>";
                                    Request += @"<com:City>Bangalore</com:City>";
                                    Request += @"<com:State>Karnataka</com:State>";
                                    Request += @"<com:PostalCode>560025</com:PostalCode>";
                                    Request += @"<com:Country>IN</com:Country>";
                                    Request += @"</com:BillingAddress>";
                                    Request += @"</com:CreditCard>";
                                    Request += @"</com:FormOfPayment>";
                                }
                                else
                                {
                                    Request += @"<com:FormOfPayment Type=""Credit"">";
                                    Request += @"<com:CreditCard BankCountryCode=" + "\"" + drCC["BankCountryCode"].ToString().Trim() + "\"" + " BankName=" + "\"" + drCC["BankName"].ToString().Trim() + "\"" + " CVV=" + "\"" + drCC["CVV"].ToString().Trim() + "\"" + " ExpDate=" + "\"" + drCC["ExpDate"].ToString().Trim() + "\"" + " Name=" + "\"" + drCC["Name"].ToString().Trim() + "\"" + " Number=" + "\"" + drCC["Number"].ToString().Trim() + "\"" + " Type=" + "\"" + drCC["Type"].ToString().Trim() + "\"" + ">";
                                    Request += @"<com:BillingAddress>";
                                    Request += @"<com:AddressName>" + drCC["AddressName"].ToString().Trim() + "</com:AddressName>";
                                    Request += @"<com:Street>" + drCC["Street"].ToString().Trim() + "</com:Street>";
                                    Request += @"<com:City>" + drCC["City"].ToString().Trim() + "</com:City>";
                                    Request += @"<com:State>" + drCC["State"].ToString().Trim() + "</com:State>";
                                    Request += @"<com:PostalCode>" + drCC["PostalCode"].ToString().Trim() + "</com:PostalCode>";
                                    Request += @"<com:Country>" + drCC["Country"].ToString().Trim() + "</com:Country>";
                                    Request += @"</com:BillingAddress>";
                                    Request += @"</com:CreditCard>";
                                    Request += @"</com:FormOfPayment>";
                                }
                ...
                foreach (DataRow dr in dtSelect.Rows)//airSegemnt
                {
                    ...
                    string ETicketability2 = dr["ETicketability"].ToString();
                    string Equipment = dr["EquipmentType"].ToString();
                    string ChangeOfPlane = dr["ChangeOfPlane"].ToString();
                    string ParticipantLevel = dr["ParticipantLevel"].ToString();
                    string LinkAvailability = dr["LinkAvailability"].ToString();
                    string PolledAvailabilityOption = dr["PolledAvailabilityOption"].ToString();
                ...
                Request += @"<air:AirPricingInfo  Key=" + "\"" + dtSelect.Rows[0]["AdtAirPricingInfoKey"].ToString() + "\"" + "  TotalPrice=" + "\"" + "INR" + AdtTotalPrice + ".00" + "\"" + " ApproximateTotalPrice=" + "\"" + "INR" + AdtTotalPrice + ".00" + "\"" + " ApproximateBasePrice=" + "\"" + "INR" + AdtBasePrice + ".00" + "\"" + " BasePrice=" + "\"" + "INR" + AdtBasePrice + ".00" + "\"" + " ApproximateTaxes=" + "\"" + "INR" + AdtTotalTaxes + ".00" + "\"" + " Taxes=" + "\"" + "INR" + AdtTotalTaxes + ".00" + "\"" + "  LatestTicketingTime=" + "\"" + Convert.ToDateTime(dtSelect.Rows[0]["LatestTicketingTime"].ToString().Trim()).ToString("yyyy-MM-dd") + "\"" + " PricingMethod=" + "\"" + dtSelect.Rows[0]["PricingMethod"].ToString().Trim() + "\"" + " Refundable=" + "\"" + Refundable + "\"" + " ETicketability=" + "\"" + ETicketability + "\"" + " PlatingCarrier=" + "\"" + dtSelect.Rows[0]["PlatingCarrier"].ToString().Trim() + "\"" + " ProviderCode=" + "\"" + dtSelect.Rows[0]["ProviderCode"].ToString().Trim() + "\"" + ">";
                ...
                for (int m = 0; m < ArayAdtFareInfo.Count; m++)
                {
                    ...
                    Request += @"<air:FareInfo PassengerTypeCode=""ADT"" Key=" + "\"" + ArayAdtFareInfo[m].ToString() + "\"" + "";
                    Request += @" Amount=" + "\"" + "INR" + TotalBasePrice + ".00" + "\"" + "";
                    Request += @" TaxAmount=" + "\"" + "INR" + TotalTaxes + ".00" + "\"" + "";
                ...
                //if (objCommonUapi.GetPromoAirlinewise(CarrierCode).Length > 0)
                //{
                //    Request += @"<air:PromoCodes>";
                //    Request += @"<air:PromoCode Code =" + "\"" + objCommonUapi.GetPromoAirlinewise(CarrierCode) + "\"" + " ProviderCode = " + "\"" + "ACH" + "\"" + " SupplierCode = " + "\"" + CarrierCode + "\"" + " />";                    
                //    Request += @"</air:PromoCodes>";
                //}
                //Request += @"</air:AirPricingModifiers>";

                CommonUapi objuapi = new CommonUapi();
                if (objuapi.GetAccountCodeUK().Length > 0 && CarrierCode.Equals("UK"))
                {
                    ...
                    //{
                    //    Request += @"<air:PromoCodes>";
                    //    Request += @"<air:PromoCode Code =" + "\"" + objCommonUapi.GetPromoAirlinewise(CarrierCode) + "\"" + " ProviderCode = " + "\"" + "1G" + "\"" + " SupplierCode = " + "\"" + CarrierCode + "\"" + " />";
                    //    Request += @"</air:PromoCodes>";
                    //}

                    Request += @"</air:AirPricingModifiers>";
                }
                else if (objuapi.GetAccountCodeAI().Length > 0 && CarrierCode.Equals("AI"))
                {
                    Request += @"<air:AirPricingModifiers AccountCodeFaresOnly=""false"">";
                    Request += @"<air:AccountCodes>";
                ...
                if (Inf > 0)
                {
                    ...
                    for (int m = 0; m < ArayInfFareInfo.Count; m++)
                    {
                        ...
                        //Request += @"<air:FareInfo PassengerTypeCode=""INF"" Key=" + "\"" + ArayInfFareInfo[m].ToString() + "\"" + " Amount=" + "\"" + "INR" + TotalBasePrice + ".00" + "\"" + " TaxAmount=" + "\"" + "INR" + TotalTaxes + ".00" + "\"" + " Origin=" + "\"" + Origin + "\"" + " Destination=" + "\"" + Destination + "\"" + " EffectiveDate=" + "\"" + EffectiveDate + "\"" + " DepartureDate=" + "\"" + DepartureDate + "\"" + " NegotiatedFare=" + "\"" + NegotiatedFare + "\"" + " NotValidBefore=" + "\"" + NotValidBefore + "\"" + " NotValidAfter=" + "\"" + NotValidAfter + "\"" + " FareBasis=" + "\"" + FareBasis + "\"" + " />";

                        Request += @"<air:FareInfo PassengerTypeCode=""INF"" Key=" + "\"" + ArayInfFareInfo[m].ToString() + "\"" + "";
                        Request += @" Amount=" + "\"" + "INR" + TotalBasePrice + ".00" + "\"" + "";
                        Request += @" TaxAmount=" + "\"" + "INR" + TotalTaxes + ".00" + "\"" + "";
                        Request += @" Origin=" + "\"" + Origin + "\"" + "";
                        Request += @" Destination=" + "\"" + Destination + "\"" + "";
                    ...
                    {
                        DataRow dr = dtInfants.CopyToDataTable().Rows[i];
                        Request += @"<air:PassengerType Code=""INF""  PricePTCOnly=""true""  Age=" + "\"" + CalculateAge(dr["DOB"].ToString()) + "\"" + " BookingTravelerRef=" + "\"" + InfBTR[i].ToString() + "\"" + "/>";
                        passengerid++;
                    }
                ...
                if (Chd > 0)
                {
                    ...
                    Request += @"<air:AirPricingInfo IncludesVAT=""false""  Key=" + "\"" + dtSelect.Rows[0]["ChdAirPricingInfoKey"].ToString() + "\"" + "  TotalPrice=" + "\"" + "INR" + ChdTotalPrice + ".00" + "\"" + " ApproximateTotalPrice=" + "\"" + "INR" + ChdTotalPrice + ".00" + "\"" + " ApproximateBasePrice=" + "\"" + "INR" + ChdBasePrice + ".00" + "\"" + " BasePrice=" + "\"" + "INR" + ChdBasePrice + ".00" + "\"" + " ApproximateTaxes=" + "\"" + "INR" + ChdTotalTaxes + ".00" + "\"" + " Taxes=" + "\"" + "INR" + ChdTotalTaxes + ".00" + "\"" + "  LatestTicketingTime=" + "\"" + Convert.ToDateTime(dtSelect.Rows[0]["LatestTicketingTime"].ToString().Trim()).ToString("yyyy-MM-dd") + "\"" + " PricingMethod=" + "\"" + dtSelect.Rows[0]["PricingMethod"].ToString().Trim() + "\"" + " Refundable=" + "\"" + Refundable + "\"" + " ETicketability=" + "\"" + ETicketability + "\"" + " PlatingCarrier=" + "\"" + dtSelect.Rows[0]["PlatingCarrier"].ToString().Trim() + "\"" + " ProviderCode=" + "\"" + dtSelect.Rows[0]["ProviderCode"].ToString().Trim() + "\"" + ">";
                    ...
                    for (int m = 0; m < ArayChdFareInfo.Count; m++)
                    {
                        ...
                        //Request += @"<air:FareInfo PassengerTypeCode=""CNN"" Key=" + "\"" + ArayChdFareInfo[m].ToString() + "\"" + " Amount=" + "\"" + "INR" + TotalBasePrice + ".00" + "\"" + " TaxAmount=" + "\"" + "INR" + TotalTaxes + ".00" + "\"" + " Origin=" + "\"" + Origin + "\"" + " Destination=" + "\"" + Destination + "\"" + " EffectiveDate=" + "\"" + EffectiveDate + "\"" + " DepartureDate=" + "\"" + DepartureDate + "\"" + " NegotiatedFare=" + "\"" + NegotiatedFare + "\"" + " NotValidBefore=" + "\"" + NotValidBefore + "\"" + " NotValidAfter=" + "\"" + NotValidAfter + "\"" + " FareBasis=" + "\"" + FareBasis + "\"" + " />";

                        Request += @"<air:FareInfo PassengerTypeCode=""CNN"" Key=" + "\"" + ArayChdFareInfo[m].ToString() + "\"" + "";
                        Request += @" Amount=" + "\"" + "INR" + TotalBasePrice + ".00" + "\"" + "";
                        Request += @" TaxAmount=" + "\"" + "INR" + TotalTaxes + ".00" + "\"" + "";
                        Request += @" Origin=" + "\"" + Origin + "\"" + "";
                        Request += @" Destination=" + "\"" + Destination + "\"" + "";
                    ...
                    {
                        DataRow dr = dtChilds.CopyToDataTable().Rows[i];
                        Request += @"<air:PassengerType Code=""CNN"" Age=" + "\"" + CalculateAge(dr["DOB"].ToString()) + "\"" + " BookingTravelerRef=" + "\"" + ChdBTR[i].ToString() + "\"" + "/>";
                        passengerid++;
                    }
                    ...
                    else if (objuapi.GetAccountCodeAI().Length > 0 && CarrierCode.Equals("AI"))
                    {
                        Request += @"<air:AirPricingModifiers AccountCodeFaresOnly=""false"">";
                        Request += @"<air:AccountCodes>";
                        Request += @"<com:AccountCode xmlns:com =""http://www.travelport.com/schema/common_v51_0"" Code=" + "\"" + objuapi.GetAccountCodeAI() + "\"" + " ProviderCode=" + "\"" + "1G" + "\"" + " SupplierCode=" + "\"" + CarrierCode + "\"" + " />";
                        Request += @"</air:AccountCodes>";
                ...
                Request += @"<com:ActionStatus Type=""ACTIVE"" ProviderCode=""1G"" TicketDate =""T*""/>";

                if (objCommonUapi.GetAccountCommissionAirlineWise(CarrierCode).Length > 0)
                {
                    Request += @"<air:AirPricingTicketingModifiers>";
                    Request += @"<air:AirPricingInfoRef Key=" + "\"" + dtSelect.Rows[0]["AdtAirPricingInfoKey"].ToString() + "\"" + " />";
                    if (Inf > 0)
                    {
                        Request += @"<air:AirPricingInfoRef Key=" + "\"" + dtSelect.Rows[0]["InfAirPricingInfoKey"].ToString() + "\"" + " />";
                    }
                    if (Chd > 0)
                    {
                        Request += @"<air:AirPricingInfoRef Key=" + "\"" + dtSelect.Rows[0]["ChdAirPricingInfoKey"].ToString() + "\"" + " />";
                    }
                    
                    Request += @"<air:TicketingModifiers>";
                    Request += @"<com:Commission Key=""3737"" Level=""Fare"" Type=""PercentBase"" Percentage=" + "\"" + objCommonUapi.GetAccountCommissionAirlineWise(CarrierCode) + "\"" + "/>";
                    Request += @"</air:TicketingModifiers>";
                    Request += @"</air:AirPricingTicketingModifiers>";
                }
        ...
        public string GetBookRequest_LCC(string CompanyID, DataTable dtSelect, DataTable dtPassenger, DataTable dtCompanyInfo, DataTable dtGstInfo,string PaymentType)
        {
            string Request = "";
            try
            {
                ...
                if (!PaymentType.ToUpper().Equals("PAYMENTHOLD"))
                {
                    ...
                    {
                        Request += @"<com:FormOfPayment Key = ""1"" Type=""Credit"">";
                        Request += @"<com:CreditCard BankCountryCode=""IN"" BankName=""VISA"" CVV=""123"" ExpDate=""2040-09"" Name=""Test Travelport"" Number=""4444333322221111"" Type=""VI""  Key=""1"">";
                        Request += @"<com:BillingAddress>";
                        Request += @"<com:AddressName>Home</com:AddressName>";
                        Request += @"<com:Street>Richmond Road</com:Street>";
                        Request += @"<com:City>Bangalore</com:City>";
