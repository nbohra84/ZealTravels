...
{
    public class GetAvailabilityResponseRT2
    {
        ...
        public GetAvailabilityResponseRT2(string NetworkUserName, string NetworkPassword, string TargetBranch, string Adt, string Chd, string Inf, string Origin, string Destination)
        {
        ...
        public DataTable SetAvailabilityResponse(string SearchID, string CompanyID, string Sector, bool IsRT, bool IsMC, string PSQRequest, string UApiResponse, string FltType, string AdtBTR, string ChdBTR, string InfBTR, bool UAPISME = false)
        {
            ...
            {
                DBCommon.Logger.dbLogg(CompanyID, 0, "GetAvailabilityResponseRT2" + "air_uapi", PSQRequest, UApiResponse, SearchID, ex.Message + "," + ex.StackTrace);
            }
            return dtBound;
        }
