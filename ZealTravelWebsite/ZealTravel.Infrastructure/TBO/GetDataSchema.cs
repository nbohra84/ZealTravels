...
namespace ZealTravel.Infrastructure.TBO
{
    ...
    {
        public static DataTable BookingPNRSchema
        {
            get
            {
                DataTable Table = new DataTable();
                Table.TableName = "BookingResponse";
        ...
        public static DataTable SchemaAddOn
        {
            get
            {
                DataTable Table = new DataTable();
                Table.TableName = "SSRAvailabilityDT";
        ...
        public static DataTable FF_Schema
        {
            get
            {
                DataTable Table = new DataTable();
                Table.TableName = "FlightFareDetail";
        ...
        public static DataTable PaxSchema
        {
            get
            {
                DataTable Table = new DataTable();
                Table.TableName = "PassengerDetail";

                Table.Columns.Add("Passengerid", typeof(Int32)).DefaultValue = 0;
        ...
        public static DataTable SchemaFareRule
        {
            ...
            {
                DataTable Table = new DataTable();
                Table.TableName = "FareRuleDetail";
