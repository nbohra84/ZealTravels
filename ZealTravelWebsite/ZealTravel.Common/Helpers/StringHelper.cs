...
namespace ZealTravel.Common.Helpers
{
    public class StringHelper
    {
        ...
        public static string GetFirstTenCharacter(string CText)
        {
        ...
        public static string GetFirstCharacterCapital(string CText)
        {
            if (string.IsNullOrEmpty(CText))
            {
                return string.Empty;
        ...
        public static string GetALLFirstCharacterCapital(string CText)
        {
            return CultureInfo.CurrentCulture.TextInfo.ToTitleCase(CText.ToLower());
        }
        public static string GetConvertedDateTime(string CText)
        {
            string Result = string.Empty;
            try
            {
        ...
        public static string GetConvertedDate(string CText)
        {
            string Result = string.Empty;
            try
            {
