...
namespace ZealTravel.Common
{
    public class CommonFunction
    {
        ...
        public static Decimal getPercentValue(Decimal iValue, Decimal dPercent)
        {
            ...
            dValue = AvgAmount(dValue.ToString());
            return dValue;
        }
        ...
        public static string ClearFareRule(string SelectedAvailabilityResponse)
        {
            try
            {
                ...
                SelectedAvailabilityResponse = CommonFunction.DataSetToString(dsAvailability, "root");
            }
            catch (Exception ex)
            {
               // dbCommon.Logger.dbLogg("", 0, "Clear_FareRule", "Response_Filter-air_api_collector-", SelectedAvailabilityResponse, "", ex.Message);
            }
            return SelectedAvailabilityResponse;
        }
